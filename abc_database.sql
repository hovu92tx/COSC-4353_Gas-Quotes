...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=322009930ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=abc+database&table=user_profiles">`abc database`.`user_profiles`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=abc+database&table=users">`abc database`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=abc+database&table=order_detail">`abc database`.`order_detail`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=abc+database&table=orders">`abc database`.`orders`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4732553c22244a3a412262797e38412b">
