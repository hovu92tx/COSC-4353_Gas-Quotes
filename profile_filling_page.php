    ...
    <section>
        <div id="center_box">
            ...
            <form action="profile_filling_action.php" method="POST">
                ...
                <div style="text-align: center;"><button id="button" type="submit" name="pf_submit_button">Save</button><button id="button" onclick="document.location='index.php'">Cancel</button></div>
            </form>
        </div>
    </section>
</body>
