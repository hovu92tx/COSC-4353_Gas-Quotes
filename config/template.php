...
function state_List()
{
    ...
    $states = array(
        ...
        "Illinois", "Indiana", "Iowa", "Kansas", "Kentucky", "Louisiana", "Maine", "Maryland", "Massachusetts", "Michigan", "Minnesota", "Missouri", "Mississippi", "Montana", "Nebraska",
    ...
    if ($para == 'profile') {
        $html = '<h2 style="text-align: center;">Profile</h2>
                <form id="profile_form" style="padding: 10px; text-align: center;" action="functions.php" method="POST">
                    ...
                    <label for="zipcode">Zipcode</label><input id="profile_input_field" name="zipcode" style="width: 80px;"  type="text" value="' . $_SESSION['cus_zipcode'] . '" maxlength="9" minlength="5" required>
        ...
        <form id="profile_form" style="padding: 10px; text-align: center;" action="functions.php" method="POST">
            ...
            <label for="state" style="width: 5em;">State</label>' . $stateList . '
            <label for="zipcode">Zipcode</label><input id="profile_input_field" name="zipcode" style="width: 80px;"  type="text" maxlength="9" minlength="5" required>
